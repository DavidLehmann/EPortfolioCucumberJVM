...
<body>
	<jsp:useBean id="loginUser" class="de.dhbwka.application.UserBean"
		...
		<table>
			...
			<tbody>
				<tr>
					<td><input id="celciusInput" type="number" value="${calc.celcius}" name="celcius" ></td>
					<td><input id="farenheitOutput" type="number" name="farenheit" disabled="disabled" value="${calc.farenheit}"></td>
				</tr>
				<tr>
					<td></td>
